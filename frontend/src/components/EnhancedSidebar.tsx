...
export const EnhancedSidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div 
      ...
      style={{
        background: 'linear-gradient(180deg, rgba(15, 23, 42, 0.98) 0%, rgba(30, 41, 59, 0.95) 50%, rgba(51, 65, 85, 0.97) 100%)',
    ...
    >
      ...
      <div 
        className="flex items-center justify-between p-6 border-b border-slate-700/20 relative"
        style={{
          background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.9) 0%, rgba(30, 41, 59, 0.8) 100%)',
          borderImageSource: 'linear-gradient(90deg, transparent, rgba(59, 130, 246, 0.2), transparent)',
          borderImageSlice: 1
        }}
      >
        {/* Subtle header glow */}
        ...
        {!collapsed && (
          <div className="flex items-center space-x-4 relative z-10">
            ...
            <div className="relative w-14 h-14">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-400 via-indigo-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/30 ring-2 ring-blue-400/30 backdrop-blur-sm border border-white/10">
            ...
            <div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent drop-shadow-lg">
                IntelliLab GC
              </h1>
        ...
        {collapsed && (
          <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center mx-auto shadow-xl shadow-blue-500/30 ring-2 ring-blue-400/20 backdrop-blur-sm border border-white/10 relative z-10">
      ...
      <nav className="flex-1 p-6 space-y-4 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-500/50 scrollbar-track-transparent relative">
          ...
          return (
            <div key={section.id} className="space-y-3">
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    hasActiveItem 
                      ...
                      : "text-slate-300 hover:text-white hover:bg-gradient-to-r hover:from-slate-700/50 hover:to-slate-600/50 border border-transparent"
                  )}
              ...
              {(collapsed || isExpanded) && (
                <div className={cn("space-y-1.5", !collapsed && "ml-3 pl-3 border-l border-slate-600/30")}>
                      ...
                      <Button
                        ...
                        className={cn(
                          ...
                          isActive 
                            ...
                            : "text-slate-300 hover:text-white hover:bg-gradient-to-r hover:from-slate-700/60 hover:to-slate-600/60 border border-transparent hover:border-slate-500/30",
              ...
              {!collapsed && section.id !== 'demo' && (
                <div className="h-px bg-gradient-to-r from-transparent via-slate-600/40 to-transparent mx-4 my-4" />
              )}
            </div>
          );
        })}
        ...
        {!collapsed && (
          <div className="relative z-10 space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-slate-200 tracking-wide">AI Analytics</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-400 font-medium tracking-wider uppercase">Enterprise Engines</span>
            ...
            <div className="enterprise-glass-card p-3 text-xs text-slate-300 font-mono tracking-wider bg-slate-800/30 border border-slate-600/30">
              <div className="flex items-center justify-between">
        ...
        {collapsed && (
          <div className="flex flex-col items-center space-y-4 relative z-10">
            ...
            <Button
              ...
              className="p-2 h-10 w-10 rounded-xl hover:bg-slate-700/50 transition-all duration-300 group enterprise-glass-card border border-slate-600/30"
            >
              <Menu className="h-5 w-5 text-slate-400 group-hover:text-white transition-colors drop-shadow-lg" />
            </Button>
          </div>
        )}
        {!collapsed && onToggleCollapse && (
          <div className="relative z-10">
            <Button
              ...
              onClick={onToggleCollapse}
              aria-label="Toggle sidebar"
              className="w-full justify-start px-4 h-11 rounded-xl hover:bg-slate-700/50 transition-all duration-300 group text-slate-400 hover:text-white enterprise-glass-card bg-slate-800/20 border border-slate-600/30"
            >
