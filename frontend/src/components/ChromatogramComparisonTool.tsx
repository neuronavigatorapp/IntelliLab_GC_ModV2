          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                {!beforeFile ? (
                  <div 
                    className="border-2 border-dashed border-red-300 rounded-xl p-8 text-center hover:border-red-400 transition-colors cursor-pointer"
                    onClick={() => beforeInputRef.current?.click()}
                  >
                    <FileImage className="w-12 h-12 text-red-400 mx-auto mb-3" />
                    <p className="text-gray-600 mb-2">Upload BEFORE chromatogram</p>
                    <p className="text-sm text-gray-400">Original method results</p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                {!afterFile ? (
                  ...
                  >
                    <FileImage className="w-12 h-12 text-green-400 mx-auto mb-3" />
                    <p className="text-gray-600 mb-2">Upload AFTER chromatogram</p>
                    <p className="text-sm text-gray-400">Optimized method results</p>
