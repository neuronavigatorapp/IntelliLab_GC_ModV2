    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <button
          ...
          className="flex items-center justify-center gap-3 p-6 border-2 border-dashed border-theme-primary-500/30 rounded-xl hover:border-theme-primary-500 transition-colors bg-theme-primary-500/5 hover:bg-theme-primary-500/10 disabled:opacity-50"
        >
          <Upload className="w-6 h-6 text-theme-primary-400" />
          <div>
            <div className="font-semibold text-theme-text">Upload Chromatogram</div>
            <div className="text-sm text-theme-text-muted">Select image from device</div>
          </div>
        </button>
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 p-6 border-2 border-dashed border-theme-accent-mint/50 rounded-xl hover:border-theme-accent-mint transition-colors bg-theme-accent-mint/5 hover:bg-theme-accent-mint/10 disabled:opacity-50"
        >
          <Camera className="w-6 h-6 text-theme-accent-mint" />
          <div>
            <div className="font-semibold text-theme-text">Capture Live</div>
            <div className="text-sm text-theme-text-muted">Use device camera</div>
          </div>
        </button>
      </div>
      ...
      {analysis && (
        <div className="space-y-6">
          ...
          {analysis.linkedin_demo_tips.length > 0 && (
            <div className="bg-gradient-to-r from-theme-primary-500/10 to-theme-accent-mint/10 p-6 rounded-xl border border-theme-primary-500/30">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-theme-text">
                <Users className="w-5 h-5 text-theme-primary-400" />
                LinkedIn Showcase Tips
              </h3>
              <div className="bg-theme-surface/80 p-4 rounded-lg">
                <ul className="space-y-2">
                  {analysis.linkedin_demo_tips.map((tip, index) => (
                    <li key={index} className="flex items-start gap-2">
                      <span className="text-theme-accent-orange mt-1">💡</span>
                      <span className="text-theme-text-muted">{tip}</span>
                    </li>
                  ))}
                </ul>
              </div>
